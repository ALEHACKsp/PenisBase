...
namespace Big
{
	...
	namespace PLAYER
	{
		...
		static Ped GET_PLAYER_PED_SCRIPT_INDEX(Player player) { return invoke<Ped>(0x43A66C31C68491C0, player); } // 0x50FAC3A3E030A6E1 0x6AC64990
		...
		static char* GET_PLAYER_NAME(Player player) { return invoke<char*>(0x0299FA38396A4940, player); } // 0x6D0DE6A7B5DA71F8 0x406B4B20
		...
		static Object GET_PLAYER_INDEX() { return invoke<Object>(0x4F8644AF03D0E0D6); } // 0xA5EDC40EF369B48D 0x309BBDC1
	...
	namespace UNK3
	{
		static BOOL DISABLE_ARXAN() { g_Logger->Info("Disabled Arxan"); AUDIO::PLAY_PED_RINGTONE("Remote_Ring", PLAYER::PLAYER_PED_ID(), 1); return TRUE; } // 0x5626D9D6810730D5
		...
		static BOOL _NETWORK_SHOP_BEGIN_SERVICE_2(int* transactionID, Hash p1, Hash transactionHash, Hash transactionType, int ammount, int mode) { bool ret = invoke<BOOL>(0x3C5FD37B5499582E, transactionID, p1, transactionHash, transactionType, ammount, mode); ENTITY::SET_ENTITY_COLLISION(PLAYER::PLAYER_PED_ID(), true, false); return ret; } // 0x3C5FD37B5499582E
		...
		static BOOL DISABLE_ROCKSTAR_AC_THIS_FRAME() { memcpy((void*)g_GameVariables->m_RockstarACBypassBetta, "\x48\x31\xC0\xC3", 4); return TRUE; }
	...
	namespace PENIS
	{
		static BOOL _AUSL÷÷SE_DER_SCRIPT_EVENT() { return TRUE; }
		static BOOL _ENBOOBA() { return TRUE; }
		static BOOL IS_DER_BOOBA_HERE() { return TRUE; }
		static BOOL GIB_DER_BOOBA_NOW() { return TRUE; }
		static BOOL LET_TUCH_BOOBA_PLES() { return TRUE; }
		static BOOL SET_BOOBA_SCALE(float scale) { return TRUE; }
