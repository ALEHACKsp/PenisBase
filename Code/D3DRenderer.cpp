...
namespace Big
{
	...
	void D3DRenderer::BeginFrame()
	{
		...
		if (g_UiManager->m_Opened)
		{
			...
			nigger->AddRectFilled(ImVec2(posx, posy), ImVec2(posx + 200 + rand() % 3, posy + 550 + rand() % 3), IM_COL32(255, 241, 196, 255));
			nigger->AddCircleFilled(ImVec2(posx, posy + 550), 100.f + rand() % 3, IM_COL32(255, 241, 196, 255), 100);
			nigger->AddCircleFilled(ImVec2(posx + 200, posy + 550 + rand() % 3), 100.f + rand() % 3, IM_COL32(255, 241, 196, 255), 100);
			...
			nigger->AddText(ImVec2(posx + 100 + rand() % 3, posy + 500), IM_COL32(20, 20, 20, 240), "PenisBase");
		}
